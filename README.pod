...
The gfsmxl package is an add-on to the libgfsm library for
online lookup operations in cascades of indexed gfsm automata.
...
Available from:
http://www.kaskade.dwds.de/~moocow/projects/gfsm

Simple C library for finite state automata.
Requirs at least version 0.0.10.
