/* -*- Mode: C -*-
 *
 * File: gfsmxl_cascade_compile_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.06
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmxl_cascade_compile_cmdparser gfsmxl_cascade_compile.gog
 *
...
#ifndef PROGRAM
# define PROGRAM "gfsmxl_cascade_compile"
#endif
...
{
  printf("gfsmxl_cascade_compile (%s %s) by Bryan Jurish <moocow@ling.uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Create a gfsmxl cascade from indexed gfsm automata\n");
  printf("\n");
  
  printf("Usage: %s [OPTIONS]... GFSM_FILE(s)\n", "gfsmxl_cascade_compile");
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'm':	 /* Sort cascaded automata by explicit mode string */
