/* -*- Mode: C -*-
 *
 * File: gfsmxl_cascade_compile_cmdparser.h
...
#ifndef gfsmxl_cascade_compile_cmdparser_h
#define gfsmxl_cascade_compile_cmdparser_h
...
struct gengetopt_args_info {
  char * mode_arg;	 /* Sort cascaded automata by explicit mode string (default=). */
...
#endif /* __cplusplus */
#endif /* gfsmxl_cascade_compile_cmdparser_h */
