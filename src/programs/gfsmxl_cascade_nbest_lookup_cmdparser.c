/* -*- Mode: C -*-
 *
 * File: gfsmxl_cascade_nbest_lookup_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.06
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmxl_cascade_nbest_lookup_cmdparser gfsmxl_cascade_nbest_lookup.gog
 *
...
#ifndef PROGRAM
# define PROGRAM "gfsmxl_cascade_nbest_lookup"
#endif
...
{
  printf("gfsmxl_cascade_nbest_lookup (%s %s) by Bryan Jurish <moocow@ling.uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Lookup N-best paths in a gfsmxl cascade\n");
  printf("\n");
  
  printf("Usage: %s [OPTIONS]... INPUT_WORDS...\n", "gfsmxl_cascade_nbest_lookup");
  
  printf("\n");
  printf(" Arguments:\n");
  printf("   INPUT_WORDS...  Input strings (implicitly concatenated)\n");
