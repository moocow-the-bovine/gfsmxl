/* -*- Mode: C -*-
 *
 * File: gfsmxl_cascade_nth_cmdparser.c
 * Description: Code for command-line parser struct gengetopt_args_info.
 *
 * File autogenerated by optgen.perl version 0.06
 * generated with the following command:
 * /usr/local/bin/optgen.perl -u -l --no-handle-rcfile --nopod -F gfsmxl_cascade_nth_cmdparser gfsmxl_cascade_nth.gog
 *
...
#ifndef PROGRAM
# define PROGRAM "gfsmxl_cascade_nth"
#endif
...
{
  printf("gfsmxl_cascade_nth (%s %s) by Bryan Jurish <moocow@ling.uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Extract the nth transducer from a compile gfsmxl cascade\n");
  printf("\n");
  
  printf("Usage: %s [OPTIONS]... CASCADE_FILE\n", "gfsmxl_cascade_nth");
  
  printf("\n");
  printf(" Arguments:\n");
  printf("   CASCADE_FILE  Stored binary gfsmxl cascade file\n");
  
  printf("\n");
  printf(" Options:\n");
  printf("   -h       --help            Print help and exit.\n");
  printf("   -V       --version         Print version and exit.\n");
  printf("   -nN      --index=N         Extract the N-th automaton in the cascade\n");
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'n':	 /* Extract the N-th automaton in the cascade */
          if (args_info->index_given) {
            fprintf(stderr, "%s: `--index' (`-n') option given more than once\n", PROGRAM);
          }
          args_info->index_given++;
          args_info->index_arg = (int)atoi(val);
          break;
