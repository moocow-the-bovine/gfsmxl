/* -*- Mode: C -*-
 *
 * File: gfsmxl_cascade_nth_cmdparser.h
...
#ifndef gfsmxl_cascade_nth_cmdparser_h
#define gfsmxl_cascade_nth_cmdparser_h
...
struct gengetopt_args_info {
  ...
  int index_given;	 /* Whether index was given */
...
#endif /* __cplusplus */
#endif /* gfsmxl_cascade_nth_cmdparser_h */
